...
class TodoListPage(PageObject):
    ...
    @property
    def el(self):
        return self.driver.find_element_by_xpath('//*[@data-test="todo-list"]')

    def wait_show_todo_list(self):
        self._wait_show('//*[@data-test="todo-list"]')
        return self
    ...
    def get_todo_rows(self):
        rows = self.el.find_elements_by_xpath('//tr[@data-test="todo-list-row"]')
        return list(map(lambda el: TodoListRow(self.driver, el), rows))

    def click_create_todo_button(self):
        b = self.el.find_element_by_xpath('//*[@data-test="create-todo-button"]')
        b.click()
        return TodoFormPage(self.driver)

    def click_all_tab(self):
        t = self.el.find_element_by_xpath('//*[@data-test="all-tab"]')
        t.click()
        return self

    def click_active_tab(self):
        t = self.el.find_element_by_xpath('//*[@data-test="active-tab"]')
        t.click()
        return self

    def click_completed_tab(self):
        t = self.el.find_element_by_xpath('//*[@data-test="completed-tab"]')
        t.click()
        return self
...
class TodoFormPage(PageObject):
    ...
    @property
    def el(self):
        return self.driver.find_element_by_xpath('//*[@data-test="todo-form"]')

    def wait_show_todo_form(self):
        self._wait_show('//*[@data-test="todo-form"]')
        return self
    ...
    def get_title(self):
        f = self.el.find_element_by_xpath('//*[@data-test="title-field"]')
    ...
    def is_complete(self):
        f = self.el.find_element_by_xpath('//*[@data-test="complete-field"]')
    ...
    def click_save_button(self):
        b = self.el.find_element_by_xpath('//*[@data-test="save-button"]')
        b.click()
        return TodoListPage(self.driver)

    def click_remove_button(self):
        b = self.el.find_element_by_xpath('//*[@data-test="remove-button"]')
        b.click()
        return self
